...
- :school: I am a `DAM Student` at [CESUR](https://www.cesurformacion.com//).
- :technologist: I love building `backend solutions` and `optimizing systems`.
- :computer: Passionate about backend development, databases, and scalable architectures.
- :student: I’m currently learning `Kotlin`, `Java`, `Python` and `backend technologies`. 
- :nerd_face: Always learning new things and improving my `skills`.  
- :thinking: I’m currently open to internship opportunities in `backend development`.
...
<p align="center">
	...
	<a href="https://www.linkedin.com/in/rodrigohern%C3%A1ndezmartin/"><img src="https://img.shields.io/badge/linkedin-%230A66C2.svg?style=plastic&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
</p>
